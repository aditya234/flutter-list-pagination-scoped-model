...
class PhotoListStream extends StatefulWidget {
  @override
  PhotoListStreamState createState() => PhotoListStreamState();
}

class PhotoListStreamState extends State<PhotoListStream> {
